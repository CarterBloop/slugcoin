Contributing to Slugcoin Core
============================

The Slugcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Slugcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/slugcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to slugcoin-qt
...
The following applies to code changes to the Slugcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Slugcoin
Network Protocol consensus changes.

Whether a pull request is merged into Slugcoin Core rests with the project merge
...
Patches that change Slugcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Slugcoin consensus, it must have been
...
The project leader is the release manager for each Slugcoin Core release.
