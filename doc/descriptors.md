# Support for Output Descriptors in Slugcoin Core

Since Slugcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Slugcoin Core wallets, a convenience function `combo` is
