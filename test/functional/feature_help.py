...
"""Verify that starting slugcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start slugcoin with -h for help text")
        ...
        self.log.info("Start slugcoin with -version for version information")
        ...
        self.log.info("Start slugcoind with -fakearg to make sure it does not start")
