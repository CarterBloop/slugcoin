...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("seed-a.slugcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.slugcointools.com");
        //vSeeds.emplace_back("dnsseed.slugcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x98, 0xA2, 0x1D};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x98, 0xB5, 0xD4};
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.slugcointools.com");
        //vSeeds.emplace_back("seed-b.slugcoin.loshan.co.uk");
