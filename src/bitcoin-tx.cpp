...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " slugcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  slugcoin-tx [options] <hex-tx> [commands]  Update hex-encoded slugcoin transaction\n" +
            "or:     slugcoin-tx [options] -create [commands]   Create hex-encoded slugcoin transaction\n" +
            "\n";
